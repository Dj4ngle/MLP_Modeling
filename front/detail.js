...
const PRESETS = [
  { id: 1, title: "Машина", model: "models/car.glb" },
  { id: 2, title: "Дерево", model: "models/tree.glb" },
  { id: 3, title: "Дом", model: "models/house.glb" },
  { id: 4, title: "Мост", model: "models/bridge.glb" },
  { id: 5, title: "Машина + Дерево", models: [
      { title: "Машина", model: "models/car.glb" },
      { title: "Дерево", model: "models/tree.glb" },
    ]
  }
];
